...
const fs = require("fs");
const ProcessorFile = require("../config/UpdateEmage")
// create department
...
const EditDepartment = async (req, res) => {
  ...
  await Department
    .findByIdAndUpdate(
      ...
      if (!response) { return res.status(500).json({ message: "Not Found" }) }
...
module.exports = { DepartmentInfo, show_Details, Delete, EditDepartment,EditFile,DepartmentDispalay };
